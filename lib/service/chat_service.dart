...
class ChatService {
  ...
  Stream<List<Map<String, dynamic>>> getListChatStream(bool isSeller,
      String id) {
    ...
    Future sendMessage(String receiverId, message, bool isSeller,
        String storeId,
    ...
    Future<void> editMessage(String userId, String otherUserId,
        String messageId,
    ...
    Future<void> deleteMessageInChatRoom(String userId, String otherUserId,
    ...
    Future<void> deleteDocumentWithSubcollections(String collectionPath,
